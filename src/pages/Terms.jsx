...
export default function Terms() {
     return (
          <main className="min-h-screen bg-gradient-to-b">
               {/* Header */}
               <div className="border-b border-purple-500/20 py-8">
                    ...
                    <div className="prose prose-invert max-w-none">
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   TipTapp provides a platform that enables users to send and receive digital tips securely through Stripe, a trusted third-party payment processor. TipTapp does not operate as a bank, payment institution, or money service business. All financial transactions are processed and managed by Stripe Connect, in accordance with applicable laws and regulations.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   <b>“Tipper”</b> – A user who sends a tip or payment through TipTapp.
                              </p>
                              <p className="text-gray-300 leading-relaxed">
                                   <b>“Service Provider”</b> – A user who receives a tip or payment through TipTapp.
                              </p>
                              <p className="text-gray-300 leading-relaxed">
                                   <b>“Platform”</b> – Refers to TipTapp, including its website, mobile app, and related services.
                              </p>
                              <p className="text-gray-300 leading-relaxed">
                                   <b>“Stripe”</b> – Refers to Stripe Payments UK Ltd, which processes all payments and payouts on behalf of TipTapp users.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   By using TipTapp, you represent that you meet these eligibility requirements.
                              </p>
                         </section>

                         <section className="mb-8">
                              <h2 className="text-2xl font-semibold text-white mb-4">4. Using TipTapp </h2>
                              ...
                              <ul className="list-disc list-inside text-gray-300 space-y-2 my-4">
                                   ...
                                   <li>If no withdrawal is made, TipTapp will automatically process all pending payouts once the oldest transaction reaches 80 days.</li>
                              </ul>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   TipTapp charges a 10% platform fee on each completed transaction. This fee is automatically deducted from the total amount before the Service Provider receives their payout. Stripe may also charge additional processing fees according to their pricing structure, which are separate from TipTapp’s service fee.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   All payment processing on TipTapp is handled by Stripe Payments UK Ltd via Stripe Connect. By using TipTapp, you agree to Stripe’s Terms of Service and Privacy Policy, available at:
                              </p>
                              <ul className="list-disc list-inside text-gray-300 space-y-2 my-4">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   TipTapp does not store or have access to your payment card details. Stripe Payments UK Ltd manages all KYC (Know Your Customer) and AML (Anti-Money Laundering) requirements for compliance purposes.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   You agree to use TipTapp only for lawful purposes and in accordance with these Terms. You must not:
                                   <ul className="list-disc list-inside text-gray-300 space-y-2 my-4">
                                        <li>Use TipTapp for money laundering, illegal gambling, or fraudulent purposes;</li>
                         ...
                         <section className="mb-8">
                              ...
                              <ul className="list-disc list-inside text-gray-300 space-y-2 mt-4">
                                   ...
                                   <li>TipTapp does not control Stripe’s payout timing and cannot guarantee exact withdrawal dates.</li>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   Tips sent through TipTapp are non-refundable. However, in rare cases of confirmed fraud, duplicate transactions, or unauthorized use, TipTapp and Stripe may assist in processing a refund at their discretion.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   TipTapp respects your privacy and is committed to protecting your personal data.
                              </p>
                              <ul className="list-disc list-inside text-gray-300 space-y-2 my-4">
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   TipTapp provides the Platform on an “as is” and “as available” basis. We make no warranties, express or implied, regarding uninterrupted access, accuracy, or suitability for a particular purpose.
                              </p>
                              <p className="text-gray-300 leading-relaxed">
                                   To the maximum extent permitted by law:
                              </p>
                              <ul className="list-disc list-inside text-gray-300 space-y-2 my-4">
                                   <li>TipTapp is not liable for any loss, damage, or claim resulting from payment delays, errors, or issues caused by Stripe or other third parties.</li>
                                   <li> TipTapp is not responsible for disputes between Tippers and Service Providers. </li>
                              </ul>
                              <p className="text-gray-300 leading-relaxed">
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   We may suspend or terminate access to TipTapp if you violate these Terms, engage in fraudulent activity, or misuse the Platform. You may also close your account at any time by contacting support@tiptapthetippingapp.com.
                              </p>
                         </section>
                         ...
                         <section className="mb-8">
                              ...
                              <p className="text-gray-300 leading-relaxed">
                                   We may update these Terms from time to time. Changes will take effect once posted on our website or app. Your continued use of TipTapp after changes means you accept the updated Terms.
                              </p>
                         </section>
