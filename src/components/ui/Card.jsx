export default function Card({ icon, title }) {
     return (
          <div className="bg-gradient-to-b from-[#0077B6] to-[#3A35B3] p-[3px] rounded-2xl shadow-[0_0_15px_2px_rgba(122,181,225,0.3)] w-[300px] hover:shadow-[0_0_25px_5px_rgba(122,181,225,0.5)] transition-all">
